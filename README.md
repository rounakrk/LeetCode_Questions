...
A systematic collection of data structures and algorithms (DSA) solutions. This repository documents my journey through LeetCode, focusing on optimized time and space complexity.

## 🚀 Overview

- **Language:** C++ (or Python/Java)
- **Goal:** Solve at least one problem daily/weekly to improve algorithmic thinking.
- **Focus:** Arrays, Linked Lists, Trees, Dynamic Programming, and System Design.

## 📁 Repository Structure

Each problem is housed in its own directory, following the naming convention:
`[Problem Number]. [Problem Name]/solution.cpp`

Example:
`./203. Remove Linked List Element/solution.cpp`
...
While my primary expertise lies in **Cloud Architecture and DevOps**, I maintain this repository to:
- Sharpen algorithmic efficiency.
- Practice low-level memory management in C++.
- Prepare for technical deep-dives and SRE-related coding challenges.
...
If you have questions about a specific approach or want to discuss a better optimization, feel free to reach out!

- **GitHub:** [Rounak Agarwal](https://github.com/rounakrk)
- **LinkedIn:** [Rounak Agarwal](https://linkedin.com/in/rounakrk)
- **Portfolio:** [Rounak Agarwal](https://rkagarwal.netlify.app/)